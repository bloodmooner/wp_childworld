        ...
        <div class="reply">
            <div class="reply__body">
                <div class="reply__title">
                    ...
                    <?php echo do_shortcode( '[contact-form-7 id="147" title="Форма с вопросом"]' ); ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('social_instagram'); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('social_facebook'); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('social_youtube'); ?>" class="footer__social-item">
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="tel:<?php the_field('footer_phone_1'); ?>"><?php the_field('footer_phone_1'); ?></a>
                                    <a href="tel:<?php the_field('footer_phone_2'); ?>"><?php the_field('footer_phone_2'); ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
                                <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="footer__contacts-logo">
                                <address><?php the_field('footer_address'); ?></address>
                            </div>
                        </div>
                    </div>
                </div>
