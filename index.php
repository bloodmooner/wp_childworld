                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span>Не нашли то, что искали?</span> <?php the_field('goods_descr'); ?>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('contact_telephone_1'); ?>"><?php the_field('contact_telephone_1'); ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('contact_telephone_2'); ?>"><?php the_field('contact_telephone_2'); ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="contacts__mail">
                                Или напишите нам на почту
                                <a href="mailto:<?php the_field('contact_email_1'); ?>"><?php the_field('contact_email_1'); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
